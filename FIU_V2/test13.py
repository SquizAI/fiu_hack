...
def main():
    ...
    page = st.sidebar.radio("Go to", ["Home", "Crime Analysis", "Traffic Analysis", "Real Estate Trends", "Weather Forecast", "News and Search Results"])

    if page == "Home":
        st.write("Welcome to the enhanced Coral Gables AI for Good Dashboard. This tool provides comprehensive insights into crime, traffic, real estate, weather, news, and search results for Coral Gables, Florida.")
